...
int task_1()
{
...

    {
        ...
        {
            sequence.push(SetEvent(SetOperator::Add, i, true));
        }
        StdSet set;
...

    {
        ...
        sequence.push(SetEvent(SetOperator::Contains, 3, false));
...

    {
        ...
        sequence.push(SetEvent(SetOperator::Remove, 3, false));
...
// TODO A02: This function tests your implementation of the `SimpleSet` class in `simple_set.hpp`
int task_2()
{
    bool valid = true;
...
/// TODO A03: This function tests your implementation of the `CoarseSet` class in `coarse_set.hpp`
int task_3()
{
    bool valid = true;
...
/// TODO A04: This function tests your implementation of the `FineSet` class in `fine_set.hpp`
int task_4()
{
    bool valid = true;
